   ...
   {users.length >0? users.map((user,index) =>{
    return(
        ...
        <tr>
            ...
            <td>{user.email}</td>
            <td>{user.password}</td>
            <td className='btn btn-danger m-1'  onClick={()=>deleteUser(user._id)}>delete</td>
            <td className='btn btn-success m-1'><Link to={`/user/${user._id}`}>details</Link></td>
            <td className='btn btn-success m-1'><Link to={`/user/edit/${user._id}`}>edit</Link></td>
       ...
       <div className='addIcon bg-success text-white d-flex justify-content-center align-items-center position-fixed'>
        <span><Link className='text-white' to={`/user/create`}>create new +</Link></span>
       </div>
