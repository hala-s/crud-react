...
export default function Edit() {
  ...
  <div className="row flex-nowrap">
    ...
    <form onSubmit={()=>sendData(event)}>
      ...
      <Input errors={errors} id={'username'} value={user.name} title={"user name"} type={"text"} name={"name"} handelData={handelData}/>
      <Input errors={errors} id={'email'} value={user.email} title={"user email"} type={"email"} name={"email"} handelData={handelData}/>
      <Input errors={errors} id={'password'} value={user.password} title={"password"} type={"password"} name={"password"} handelData={handelData}/>
